...
#define COLOR_GREEN [UIColor colorWithHexString:@"#16C29E"]
...
//审核
#define NOTICE_AUDIT_CAR @"NOTICE_AUDIT_CAR"//审核车辆
#define NOTICE_AUDIT_DRIVER @"NOTICE_AUDIT_DRIVER"//审核司机
#define NOTICE_AUDIT_COMPANY @"NOTICE_AUDIT_COMPANY"//审核公司
