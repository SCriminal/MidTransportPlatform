...
#import "AuditDriverListManagementVC.h"
//滑动view
#import "SliderView.h"
//sub Vc
...
- (void)setupChildVC
{
    for (int i = 0; i <self.arySliderDatas.count; i++) {
        ...
        AuditDriverListVC *sourceVC = [[AuditDriverListVC alloc] init];
...
- (void)addNav{
    //    WEAKSELF
    BaseNavView * nav = [BaseNavView initNavBackTitle:@"司机审核" rightTitle:@"" rightBlock:nil];
