//
//  AuditCompanyListManagementVC.m
//  Driver
//
...
#import "AuditCompanyListManagementVC.h"
//滑动view
#import "SliderView.h"
//sub Vc
#import "AuditCompanyListVC.h"

@interface AuditCompanyListManagementVC ()<SliderViewDelegate,UIScrollViewDelegate>
...
@implementation AuditCompanyListManagementVC
...
- (void)setupChildVC
{
    for (int i = 0; i <self.arySliderDatas.count; i++) {
        ...
        AuditCompanyListVC *sourceVC = [[AuditCompanyListVC alloc] init];
...
- (void)addNav{
    //    WEAKSELF
    BaseNavView * nav = [BaseNavView initNavBackTitle:@"企业审核" rightTitle:@"" rightBlock:nil];
