...
- (void)timerRun{
    ...
    if (_numTime <=0) {
        ...
        self.labelResend.textColor = COLOR_GREEN;
...
- (void)resetViewWithModel:(id)model{
    ...
    for (int i = 0; i<6; i++) {
        ...
        labelShow.textColor = COLOR_GREEN;
...
- (void)textChange{
    ...
    for (int i = 0; i<6; i++) {
        ...
        [GlobalMethod setRoundView:viewLine color:str.length >= i+1?COLOR_GREEN:COLOR_LINE numRound:5 width:1];
    }
